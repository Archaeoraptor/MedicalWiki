...
INSERT INTO mw_privilege (privilege_id, name, parent_id, type, controller, action, icon, target, is_display, sequence, create_time, update_time) VALUES (72, '相关链接', 71, 'controller', 'link', 'list', 'glyphicon-list', '', 1, 81, unix_timestamp(now()), unix_timestamp(now()));
...
-- 系统配置
-- -------------------------------------------
INSERT INTO `mw_config` VALUES ('1', '主页标题', 'main_title', '欢迎来到医学知识分享与团队协作平台！', unix_timestamp(now()), unix_timestamp(now()));
INSERT INTO `mw_config` VALUES ('2', '主页描述', 'main_description', '使用中有任何问题请联系管理员 admin@xi102.com！', unix_timestamp(now()), unix_timestamp(now()));
...
INSERT INTO `mw_config` (name, `key`, value, create_time, update_time) VALUES ('系统名称', 'system_name', '医学知识分享平台', unix_timestamp(now()), unix_timestamp(now()));
